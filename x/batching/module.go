...
import (
	...
	"github.com/sedaprotocol/seda-chain/x/batching/client/cli"
...
// ValidateGenesis performs genesis state validation for the batching module.
...
func (am AppModule) InitGenesis(ctx sdk.Context, cdc codec.JSONCodec, gs json.RawMessage) {
	...
	am.keeper.StreamImportGenesis(ctx, cdc)
}

// ExportGenesis returns the module's exported genesis state as raw JSON bytes.
func (am AppModule) ExportGenesis(ctx sdk.Context, cdc codec.JSONCodec) json.RawMessage {
	am.keeper.StreamExportGenesis(ctx, cdc)
	return nil

	// am.keeper.ExportGenesis(ctx)
