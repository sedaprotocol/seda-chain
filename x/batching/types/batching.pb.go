...
type Params struct {
	...
	// block.
	MaxBatchPrunePerBlock uint64 `protobuf:"varint,1,opt,name=max_batch_prune_per_block,json=maxBatchPrunePerBlock,proto3" json:"max_batch_prune_per_block,omitempty"`
	// MaxLegacyDataResultPrunePerBlock is the maximum number of legacy data
	// results to be checked for pruning per block.
	MaxLegacyDataResultPrunePerBlock uint64 `protobuf:"varint,2,opt,name=max_legacy_data_result_prune_per_block,json=maxLegacyDataResultPrunePerBlock,proto3" json:"max_legacy_data_result_prune_per_block,omitempty"`
}
...
var fileDescriptor_5b2a028024867de2 = []byte{
	...
	,
}
