...
type Batch struct {
	...
	// data_result_leaves are the leaves of the data result tree.
	DataResultLeaves [][]byte `protobuf:"bytes,5,rep,name=data_result_leaves,json=dataResultLeaves,proto3" json:"data_result_leaves,omitempty"`
	// validator_leaves are the leaves of the validator tree.
	ValidatorLeaves [][]byte `protobuf:"bytes,6,rep,name=validator_leaves,json=validatorLeaves,proto3" json:"validator_leaves,omitempty"`
...
func (m *Batch) GetDataResultLeaves() [][]byte {
	if m != nil {
		return m.DataResultLeaves
	}
	return nil
}

func (m *Batch) GetValidatorLeaves() [][]byte {
	if m != nil {
		return m.ValidatorLeaves
	}
	return nil
}
...
type DataResult struct {
	...
	PaybackAddress string `protobuf:"bytes,7,opt,name=payback_address,json=paybackAddress,proto3" json:"payback_address,omitempty"`
	// seda_payload is the payload set by SEDA Protocol (e.g. OEC-enabled
	// data requests)
	SedaPayload string `protobuf:"bytes,8,opt,name=seda_payload,json=sedaPayload,proto3" json:"seda_payload,omitempty"`
	// consensus indicates whether consensus was reached in the tally
	// process.
	Consensus bool `protobuf:"varint,9,opt,name=consensus,proto3" json:"consensus,omitempty"`
}
...
func (m *DataResult) GetGasUsed() string {
	if m != nil {
		return m.GasUsed
	}
	return ""
...
var fileDescriptor_5b2a028024867de2 = []byte{
	...
	,
}
...
func (m *Batch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x3a
	if len(m.ValidatorLeaves) > 0 {
		for iNdEx := len(m.ValidatorLeaves) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ValidatorLeaves[iNdEx])
			copy(dAtA[i:], m.ValidatorLeaves[iNdEx])
			i = encodeVarintBatching(dAtA, i, uint64(len(m.ValidatorLeaves[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
	if len(m.DataResultLeaves) > 0 {
		for iNdEx := len(m.DataResultLeaves) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.DataResultLeaves[iNdEx])
			copy(dAtA[i:], m.DataResultLeaves[iNdEx])
			i = encodeVarintBatching(dAtA, i, uint64(len(m.DataResultLeaves[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *DataResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GasUsed) > 0 {
		...
		i = encodeVarintBatching(dAtA, i, uint64(len(m.GasUsed)))
		i--
		dAtA[i] = 0x2a
	}
	if m.ExitCode != 0 {
...
func (m *Batch) Size() (n int) {
	...
	if len(m.DataResultLeaves) > 0 {
		for _, b := range m.DataResultLeaves {
			l = len(b)
			n += 1 + l + sovBatching(uint64(l))
		}
	}
	if len(m.ValidatorLeaves) > 0 {
		for _, b := range m.ValidatorLeaves {
			l = len(b)
			n += 1 + l + sovBatching(uint64(l))
		}
	}
...
func (m *Batch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DataResultLeaves", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DataResultLeaves = append(m.DataResultLeaves, make([]byte, postIndex-iNdEx))
			copy(m.DataResultLeaves[len(m.DataResultLeaves)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidatorLeaves", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValidatorLeaves = append(m.ValidatorLeaves, make([]byte, postIndex-iNdEx))
			copy(m.ValidatorLeaves[len(m.ValidatorLeaves)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
