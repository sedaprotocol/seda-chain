...
type GenesisState struct {
	...
	LegacyDataResults    []GenesisDataResult `protobuf:"bytes,7,rep,name=legacy_data_results,json=legacyDataResults,proto3" json:"legacy_data_results"`
	HasPruningCaughtUp   bool                `protobuf:"varint,8,opt,name=has_pruning_caught_up,json=hasPruningCaughtUp,proto3" json:"has_pruning_caught_up,omitempty"`
	BatchNumberAtUpgrade uint64              `protobuf:"varint,9,opt,name=batch_number_at_upgrade,json=batchNumberAtUpgrade,proto3" json:"batch_number_at_upgrade,omitempty"`
}
...
func (m *GenesisState) GetLegacyDataResults() []GenesisDataResult {
	if m != nil {
		return m.LegacyDataResults
	}
	return nil
}

func (m *GenesisState) GetHasPruningCaughtUp() bool {
	if m != nil {
		return m.HasPruningCaughtUp
	}
	return false
}

func (m *GenesisState) GetBatchNumberAtUpgrade() uint64 {
	if m != nil {
		return m.BatchNumberAtUpgrade
	}
	return 0
}
...
var fileDescriptor_eccca5d98d3cb479 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BatchNumberAtUpgrade != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.BatchNumberAtUpgrade))
		i--
		dAtA[i] = 0x48
	}
	if m.HasPruningCaughtUp {
		i--
		if m.HasPruningCaughtUp {
			dAtA[i] = 1
		} else {
	...
	if len(m.LegacyDataResults) > 0 {
		for iNdEx := len(m.LegacyDataResults) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LegacyDataResults[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	n += 1 + l + sovGenesis(uint64(l))
	if len(m.LegacyDataResults) > 0 {
		for _, e := range m.LegacyDataResults {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
	...
	if m.BatchNumberAtUpgrade != 0 {
		n += 1 + sovGenesis(uint64(m.BatchNumberAtUpgrade))
	}
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LegacyDataResults", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LegacyDataResults = append(m.LegacyDataResults, GenesisDataResult{})
			if err := m.LegacyDataResults[len(m.LegacyDataResults)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasPruningCaughtUp", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HasPruningCaughtUp = bool(v != 0)
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchNumberAtUpgrade", wireType)
			}
			m.BatchNumberAtUpgrade = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BatchNumberAtUpgrade |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
