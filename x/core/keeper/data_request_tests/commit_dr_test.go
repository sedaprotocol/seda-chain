...
// TODO: failing not getting correct error message
func TestFailsIfTimedOut(t *testing.T) {
	f := testutil.InitFixture(t, false, nil)
...
func TestFailsOnExpiredDr(t *testing.T) {
	f := testutil.InitFixture(t, false, nil)
...
func TestCommitWorks(t *testing.T) {
	...
	// // TODO: Test Alice was refunded
	// aliceBalance := alice.Balance()
	// require.Equal(t, f.SedaToAseda(21), aliceBalance)
}
...
func TestWrongSignatureFails(t *testing.T) {
	...
	f.SetTx(20_000, alice.AccAddress(), msg)
