...
func (k Keeper) ProcessDistributions(ctx sdk.Context, tr *TallyResult, minimumStake math.Int, burnRatio math.LegacyDec) error {
	dists := k.GetGasMeterResults(ctx, tr.GasMeter, tr.ID, int64(tr.Height), burnRatio)
