...
var (
	...
	ErrDataRequestIndexNotFound      = errors.Register("core", 43, "data request index was not found under given status")
	ErrDataRequestIndexAlreadyExists = errors.Register("core", 44, "data request index already exists under given status")
	ErrInvalidDataRequestStatus      = errors.Register("core", 45, "invalid data request status")
	ErrUnexpectDataRequestCount      = errors.Register("core", 46, "unexpected data request count")
	ErrUnexpectedZeroCount           = errors.Register("core", 50, "unexpected zero count")
	ErrUnexpectedStakerKey           = errors.Register("core", 51, "unexpected staker key at index")
