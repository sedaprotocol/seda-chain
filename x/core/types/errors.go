...
var (
	...
	ErrFilterDidNotRun        = errors.Register("core", 49, "filter did not run")
	// Errors used in tally program execution:
	ErrDecodingPaybackAddress     = errors.Register("core", 50, "failed to decode payback address")
	ErrFindingTallyProgram        = errors.Register("core", 51, "failed to find tally program")
	ErrDecodingTallyInputs        = errors.Register("core", 52, "failed to decode tally inputs")
	ErrConstructingTallyVMArgs    = errors.Register("core", 53, "failed to construct tally VM arguments")
	ErrGettingMaxTallyGasLimit    = errors.Register("core", 54, "failed to get max tally gas limit")
	ErrInvalidStatusTransition    = errors.Register("core", 55, "invalid status transition")
	ErrDataRequestNotFoundInIndex = errors.Register("core", 56, "data request not found in index")
)
