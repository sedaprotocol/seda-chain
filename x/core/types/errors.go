...
var (
	...
	ErrInvalidStatusTransition   = errors.Register("core", 205, "invalid status transition")
	ErrDataRequestStatusNotFound = errors.Register("core", 206, "data request index was not found under given status")
	ErrInvalidDataRequestStatus  = errors.Register("core", 207, "invalid data request status")
	ErrUnexpectDataRequestCount  = errors.Register("core", 208, "unexpected data request count")
)
