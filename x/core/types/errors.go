...
var (
	...
	ErrInvalidRevealProof            = errors.Register("core", 39, "invalid reveal proof")
	ErrModuleAlreadyPaused           = errors.Register("core", 40, "module is already paused")
	ErrModuleAlreadyUnpaused         = errors.Register("core", 41, "module is already unpaused")
	ErrModulePaused                  = errors.Register("core", 42, "module is paused")
	ErrInvalidStatusTransition       = errors.Register("core", 43, "invalid status transition")
	ErrDataRequestNotFound           = errors.Register("core", 44, "data request was not found")
	ErrDataRequestIndexNotFound      = errors.Register("core", 45, "data request index was not found under given status")
	ErrDataRequestIndexAlreadyExists = errors.Register("core", 46, "data request index already exists under given status")
	ErrInvalidDataRequestStatus      = errors.Register("core", 47, "invalid data request status")
	ErrUnexpectDataRequestCount      = errors.Register("core", 48, "unexpected data request count")
