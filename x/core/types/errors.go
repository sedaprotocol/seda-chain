...
var (
	...
	ErrModuleAlreadyPaused           = errors.Register("core", 39, "module is already paused")
	ErrModuleAlreadyUnpaused         = errors.Register("core", 40, "module is already unpaused")
	ErrModulePaused                  = errors.Register("core", 41, "module is paused")
	ErrInvalidStatusTransition       = errors.Register("core", 42, "invalid status transition")
	ErrDataRequestNotFound           = errors.Register("core", 43, "data request was not found")
	ErrDataRequestIndexNotFound      = errors.Register("core", 44, "data request index was not found under given status")
	ErrDataRequestIndexAlreadyExists = errors.Register("core", 45, "data request index already exists under given status")
	ErrInvalidDataRequestStatus      = errors.Register("core", 46, "invalid data request status")
	ErrUnexpectDataRequestCount      = errors.Register("core", 47, "unexpected data request count")
	ErrUnexpectedZeroCount           = errors.Register("core", 48, "unexpected zero count")
	ErrUnexpectedStakerKey           = errors.Register("core", 49, "unexpected staker key at index")
	...
	ErrInvalidPathLen         = errors.Register("core", 102, "invalid JSON path length")
	ErrInvalidNumberType      = errors.Register("core", 103, "invalid number type specified")
	ErrInvalidFilterInput     = errors.Register("core", 104, "invalid filter input")
	ErrInvalidSigmaMultiplier = errors.Register("core", 105, "invalid sigma multiplier")
	ErrOutOfTallyGas          = errors.Register("core", 106, "out of tally gas")
	ErrConsensusInError       = errors.Register("core", 107, "consensus in error")
	ErrNoConsensus            = errors.Register("core", 108, "> 1/3 of reveals do not agree on reveal data")
	ErrNoBasicConsensus       = errors.Register("core", 109, "> 1/3 of reveals do not agree on (exit_code_success, proxy_pub_keys)")
	ErrFilterDidNotRun        = errors.Register("core", 110, "filter did not run")

	// Errors used in tally program execution:
	ErrDecodingPaybackAddress  = errors.Register("core", 200, "failed to decode payback address")
	ErrFindingTallyProgram     = errors.Register("core", 201, "failed to find tally program")
	ErrDecodingTallyInputs     = errors.Register("core", 202, "failed to decode tally inputs")
	ErrConstructingTallyVMArgs = errors.Register("core", 203, "failed to construct tally VM arguments")
	ErrGettingMaxTallyGasLimit = errors.Register("core", 204, "failed to get max tally gas limit")
)
