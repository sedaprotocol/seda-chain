...
var (
	...
	ErrDataRequestStatusNotFound      = errors.Register("core", 43, "data request index was not found under given status")
	ErrDataRequestStatusAlreadyExists = errors.Register("core", 44, "data request index already exists under given status")
