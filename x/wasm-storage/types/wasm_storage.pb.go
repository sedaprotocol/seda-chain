...
type Wasm struct {
	...
	PruneHeight int64 `protobuf:"varint,5,opt,name=prune_height,json=pruneHeight,proto3" json:"prune_height,omitempty"`
}
...
func (m *Wasm) GetPruneHeight() int64 {
	if m != nil {
...
var fileDescriptor_9a4bda463450c942 = []byte{
	...
	0x14, 0xc5, 0x3d, 0x8d, 0xbf, 0xc6, 0xdf, 0xa4, 0x25, 0xe9, 0x94, 0x3f, 0xc1, 0x48, 0xb6, 0x09,
	...
	0xaf, 0x99, 0xac, 0x46, 0x22, 0x14, 0x3a, 0x23, 0x4a, 0xba, 0x61, 0x8f, 0x14, 0x57, 0xd8, 0x7c,
	0xd1, 0xa3, 0xd7, 0xf0, 0x7f, 0x86, 0x40, 0x47, 0x7d, 0x52, 0xcc, 0x28, 0xa0, 0x7c, 0x6f, 0xf7,
	...
	,
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PruneHeight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
