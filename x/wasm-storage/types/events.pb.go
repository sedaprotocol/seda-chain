...
// The msg for storing an executor wasm.
type EventStoreExecutorWasm struct {
	Hash     string `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`
	Bytecode []byte `protobuf:"bytes,2,opt,name=bytecode,proto3" json:"bytecode,omitempty"`
}

func (m *EventStoreExecutorWasm) Reset()         { *m = EventStoreExecutorWasm{} }
func (m *EventStoreExecutorWasm) String() string { return proto.CompactTextString(m) }
func (*EventStoreExecutorWasm) ProtoMessage()    {}
func (*EventStoreExecutorWasm) Descriptor() ([]byte, []int) {
	return fileDescriptor_90b0422555944a3a, []int{1}
}
func (m *EventStoreExecutorWasm) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventStoreExecutorWasm) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventStoreExecutorWasm.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventStoreExecutorWasm) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventStoreExecutorWasm.Merge(m, src)
}
func (m *EventStoreExecutorWasm) XXX_Size() int {
	return m.Size()
}
func (m *EventStoreExecutorWasm) XXX_DiscardUnknown() {
	xxx_messageInfo_EventStoreExecutorWasm.DiscardUnknown(m)
}

var xxx_messageInfo_EventStoreExecutorWasm proto.InternalMessageInfo

func (m *EventStoreExecutorWasm) GetHash() string {
	if m != nil {
		return m.Hash
	}
	return ""
...
func (m *EventStoreExecutorWasm) GetBytecode() []byte {
	if m != nil {
		return m.Bytecode
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*EventStoreExecutorWasm)(nil), "sedachain.wasm_storage.v1.EventStoreExecutorWasm")
}
...
var fileDescriptor_90b0422555944a3a = []byte{
	...
	,
}
...
func (m *EventStoreExecutorWasm) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventStoreExecutorWasm) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventStoreExecutorWasm) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventStoreExecutorWasm) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventStoreExecutorWasm) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventStoreExecutorWasm: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventStoreExecutorWasm: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
