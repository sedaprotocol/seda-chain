...
// Source: /Users/hykim/go/pkg/mod/github.com/!cosm!wasm/wasmd@v0.60.5/x/wasm/types/exported_keepers.go
//
// Generated by this command:
//
//	mockgen -source=/Users/hykim/go/pkg/mod/github.com/!cosm!wasm/wasmd@v0.60.5/x/wasm/types/exported_keepers.go -package testutil -destination=x/wasm-storage/keeper/testutil/wasm_keepers_mock.go
//
...
// GetWasmLimits mocks base method.
func (m *MockViewKeeper) GetWasmLimits() types0.WasmLimits {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWasmLimits")
	ret0, _ := ret[0].(types0.WasmLimits)
	return ret0
}

// GetWasmLimits indicates an expected call of GetWasmLimits.
func (mr *MockViewKeeperMockRecorder) GetWasmLimits() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWasmLimits", reflect.TypeOf((*MockViewKeeper)(nil).GetWasmLimits))
}
...
func (m *MockIBCContractKeeper) LoadAsyncAckPacket(ctx context.Context, portID, channelID string, sequence uint64) (types2.Packet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadAsyncAckPacket", ctx, portID, channelID, sequence)
	ret0, _ := ret[0].(types2.Packet)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIBCContractKeeper) StoreAsyncAckPacket(ctx context.Context, packet types2.Packet) error {
	m.ctrl.T.Helper()
