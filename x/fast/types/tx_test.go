...
func (s *TypesTestSuite) TestMsgRegisterFastClient_ValidateBasic() {
...
func (s *TypesTestSuite) TestMsgEditFastClient_ValidateBasic() {
	tests := []struct {
		name    string
	...
	}{
		{
			...
			msg: &types.MsgEditFastClient{
				...
				FastClientPublicKey: types.DoNotModifyField,
...
func (s *TypesTestSuite) TestMsgTransferOwnership_ValidateBasic() {
	...
	tests := []struct {
		...
		{
			name: "invalid fast client public key",
			msg: &types.MsgTransferOwnership{
				OwnerAddress:        "seda1uea9km4nup9q7qu96ak683kc67x9jf7ste45z5",
				NewOwnerAddress:     "seda1wyzxdtpl0c99c92n397r3drlhj09qfjvf6teyh",
				FastClientPublicKey: "not valid hex",
			},
			wantErr: sdkerrors.ErrInvalidRequest,
		},
		{
			name: "empty fast client public key",
			msg: &types.MsgTransferOwnership{
				OwnerAddress:        "seda1uea9km4nup9q7qu96ak683kc67x9jf7ste45z5",
				NewOwnerAddress:     "seda1wyzxdtpl0c99c92n397r3drlhj09qfjvf6teyh",
				FastClientPublicKey: "",
...
func (s *TypesTestSuite) TestMsgTopUpUser_ValidateBasic() {
	pubKeyHex := "02100efce2a783cc7a3fbf9c5d15d4cc6e263337651312f21a35d30c16cb38f4c3"
