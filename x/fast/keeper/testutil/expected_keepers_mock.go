...
// Source: x/fast/types/expected_keepers.go
//
// Generated by this command:
//
//	mockgen -source=x/fast/types/expected_keepers.go -package testutil -destination=x/fast/keeper/testutil/expected_keepers_mock.go
//
