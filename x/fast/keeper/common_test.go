...
import (
	...
	"github.com/sedaprotocol/seda-chain/x/fast/keeper"
	"github.com/sedaprotocol/seda-chain/x/fast/keeper/testutil"
...
func (s *KeeperTestSuite) SetupTest() {
	...
	encCfg := moduletestutil.MakeTestEncodingConfig(fast.AppModuleBasic{})
