...
sedad add-genesis-account $(sedad keys show validator1 -a --keyring-backend=test --home=$HOME/.sedad/validator1) 10000000000000000000aseda --home=$HOME/.sedad/validator1
...
tmux send -t validator1 'sedad start --home=$HOME/.sedad/validator1' ENTER

tmux new-session -s validator2 -d 
tmux send -t validator2 'sedad start --home=$HOME/.sedad/validator2' ENTER
...
sleep 7
sedad tx bank send validator1 $(sedad keys show validator2 -a --keyring-backend=test --home=$HOME/.sedad/validator2) 500000000aseda --keyring-backend=test --home=$HOME/.sedad/validator1 --chain-id=testing --broadcast-mode block --node http://localhost:26657 --yes --fees 1000000aseda
sedad tx bank send validator1 $(sedad keys show validator3 -a --keyring-backend=test --home=$HOME/.sedad/validator3) 400000000aseda --keyring-backend=test --home=$HOME/.sedad/validator1 --chain-id=testing --broadcast-mode block --node http://localhost:26657 --yes --fees 1000000aseda
sedad tx bank send validator1 $(sedad keys show validator4 -a --keyring-backend=test --home=$HOME/.sedad/validator4) 400000000aseda --keyring-backend=test --home=$HOME/.sedad/validator1 --chain-id=testing --broadcast-mode block --node http://localhost:26657 --yes --fees 1000000aseda

# create second, third and fourth validator
sedad tx staking create-validator --amount=500000000aseda --from=validator2 --pubkey=$(sedad tendermint show-validator --home=$HOME/.sedad/validator2) --moniker="validator2" --chain-id="testing" --commission-rate="0.1" --commission-max-rate="0.2" --commission-max-change-rate="0.05" --min-self-delegation="500000000" --keyring-backend=test --home=$HOME/.sedad/validator2 --broadcast-mode block --node http://localhost:26657 --yes --fees 1000000aseda
sedad tx staking create-validator --amount=400000000aseda --from=validator3 --pubkey=$(sedad tendermint show-validator --home=$HOME/.sedad/validator3) --moniker="validator3" --chain-id="testing" --commission-rate="0.1" --commission-max-rate="0.2" --commission-max-change-rate="0.05" --min-self-delegation="400000000" --keyring-backend=test --home=$HOME/.sedad/validator3 --broadcast-mode block --node http://localhost:26657 --yes --fees 1000000aseda
sedad tx staking create-validator --amount=400000000aseda --from=validator4 --pubkey=$(sedad tendermint show-validator --home=$HOME/.sedad/validator4) --moniker="validator4" --chain-id="testing" --commission-rate="0.1" --commission-max-rate="0.2" --commission-max-change-rate="0.05" --min-self-delegation="400000000" --keyring-backend=test --home=$HOME/.sedad/validator4 --broadcast-mode block --node http://localhost:26657 --yes --fees 1000000aseda
