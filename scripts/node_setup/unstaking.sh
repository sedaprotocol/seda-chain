...
auth_seda_chaind_command tx staking unbond $validator_address  --gas=auto --gas-adjustment=1.2 --gas-prices=0.0025aseda --from=$KEY_NAME --yes --home=$HOME/.sedad --chain-id=$chain_id $STAKE_AMOUNT