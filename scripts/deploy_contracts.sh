...
$BIN tx wasm-storage store-oracle-program ./testutil/testwasms/rpc-call.wasm --from $DEV_ACCOUNT --keyring-backend test --gas auto --gas-adjustment 1.5 --gas-prices 10000000000aseda --chain-id $CHAIN_ID -y
