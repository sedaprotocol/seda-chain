...
var (
	...
	AppConfig = depinject.Configs(appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			// {
			// 	Name:   wasm.ModuleName,
			// 	Config: appconfig.WrapAny(&circuitmodulev1.Module{}),
			// },
			// custom modules
			{
				Name:   batchingtypes.ModuleName,
				Config: appconfig.WrapAny(&batching.Module{}),
			},
			{
				Name:   dataproxytypes.ModuleName,
				Config: appconfig.WrapAny(&dataproxy.Module{}),
			},
			{
				Name:   pubkeytypes.ModuleName,
				Config: appconfig.WrapAny(&pubkey.Module{}),
			},
			{
			...
			// 		Bech32PrefixValidator: "sedavaloper",
			// 		Bech32PrefixConsensus: "sedavalcons",
			// 	}),
			// },
			{
				Name:   tallytypes.ModuleName,
				Config: appconfig.WrapAny(&tally.Module{}),
			},
			{
			...
			{
				Name:   wasmstoragetypes.ModuleName,
				Config: appconfig.WrapAny(&wasmstorage.Module{}),
			},
		},
	}),
		depinject.Supply(
